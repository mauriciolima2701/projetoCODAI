...
function getCashIn(){
    ...
    const cashIn = transactions.filter((item)=> item.type=="1"); //Percorre o array e busca somente o tipo "1" = Entrada
    ...
    if (cashIn.length){
        ...
        document.getElementById("cash-in-list").innerHTML = cashInHtml; //pegando o ID do container no HTML e adicionando o cashInHtml
...
function getCashOut(){
    ...
    const cashIn = transactions.filter((item)=> item.type=="2"); //Percorre o array e busca somente o tipo "2" = Saída
    ...
    if (cashIn.length){
        ...
        document.getElementById("cash-out-list").innerHTML = cashInHtml; //pegando o ID do container no HTML e adicionando o cashIntHtml
